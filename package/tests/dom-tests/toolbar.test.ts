...
import { createToolbar, createToolbarButton, createToolbarContentWrapper, createToolbarElement, createToolbarSubTitle, createToolbarTitle, createToolbarWrapper, toggleToolbarWrapper } from '../../src/ui/toolbar';
...
describe('toolbar', () => {
  describe('createToolbar', () => {
    it('should create a tooltip', () => {
      ...
      expect(toolbarWrap.classList.contains('astro-page-insight-toolbar-wrap')).toBe(true);
      expect(toolbarWrap.parentElement?.classList.contains('astro-page-insight-toolbar')).toBe(true);
    });
  });
  ...
  describe('createToolbarButton', () => {
    it('should create a toolbarButton', () => {
      ...
      expect(button.parentElement?.classList.contains('astro-page-insight-toolbar-button-wrap')).toBe(true);
    });
    ...
    it('should create a toolbarButton with type', () => {
      ...
      expect(button.parentElement?.classList.contains(`astro-page-insight-toolbar-button-wrap-${type}`)).toBe(true);
    });
    ...
    it('should create a toolbarButton with onclick', () => {
      ...
      const button = createToolbarButton(icon, buttonParent, disabled, type, onClick);
    ...
    it('should create a toolbarButton with tooltip', () => {
      ...
      const button = createToolbarButton(icon, buttonParent, disabled, type, onClick, tooltip);
  ...
  describe('createToolbarWrapper', () => {
    it('should create a toolbarWrapper', () => {
      ...
      expect(toolbarWrapper.classList.contains(`astro-page-insight-modal-${type}`)).toBe(true);
    });
  });
  ...
  describe('createToolbarTitle', () => {
    it('should create a toolbarTitle', () => {
      ...
      if (toolbarTitle.children[0]) expect(toolbarTitle.children[0].innerHTML).toBe(icon);
      if (toolbarTitle.children[1]) expect(toolbarTitle.children[1].innerHTML).toBe(title);
    });
    ...
    it('should create a toolbarTitle with subText', () => {
      ...
      if (toolbarTitle.children[0]) expect(toolbarTitle.children[0].innerHTML).toBe(icon);
      if (toolbarTitle.children[1]) expect(toolbarTitle.children[1].innerHTML).toBe(title);
      if (toolbarTitle.children[2]) expect(toolbarTitle.children[2].innerHTML).toBe(subText);
    });
  });
